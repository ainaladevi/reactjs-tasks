    ...
    <div className="container pharmacydashboard-cards mt-4 ms-3">
      <div className="pharmacy row">
        <div className=" pharmacy-cards col-lg-3">
          <span className="pharmacy-items"><RiCapsuleLine size={20} color="#0084D1" /> Pharmacy Prescriptions</span>
          <p className="pharmacy-items1">15 Orders</p>
        </div>
        <div className="pharmacy-cards col-lg-3">
          <span className="pharmacy-items"><FiPackage size={20} color="#F54900" /> Low Stock Items</span>
          <p className="pharmacy-items1">3 Items</p>
        </div>
        <div className="pharmacy-cards col-lg-3">
          <span className="pharmacy-items"><LuTriangleAlert size={20} color="#E7000B" /> Expiring Soon</span>
          <p className="pharmacy-items1">1 Items</p>
        </div>
        <div className="pharmacy-cards col-lg-3">
          <span className="pharmacy-items"><IoMdCheckmarkCircleOutline size={20} color="#00A63E" /> Completed Today</span>
          <p className="pharmacy-items1">42 Dispensed</p>
        </div>
      </div>
      <div className="stock row mt-4">
